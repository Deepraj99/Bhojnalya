...
public class VegMenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View vegMenuFragment = inflater.inflate(R.layout.fragment_veg_menu, container, false);
        ...
        currentDay = vegMenuFragment.findViewById(R.id.current_day_tv);
        currentDay.setText("It's " + dayOfTheWeek.toLowerCase() + " today!");
        listView = vegMenuFragment.findViewById(R.id.customListView);
